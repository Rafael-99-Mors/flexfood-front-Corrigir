        ...
        <Container sx={{ mt: 10 }}>
            <Paper sx={{ p:5 }}>
                ...
                <Button component="label" variant='contained' startIcon={<CloudUpload/>} sx={{ mb:2 }}>
                    <input type="file" onChange={(e) => {setFoto(e.target.files[0]) }} style={{display:'nome'}}/>
                    Enviar Foto
                </Button>
                ...
                <TextField ImputLabelProps={{ shrink:true }} value={quantidadeEstoque} label="Quantidade em Estoque" type='number' fullWidth onChange={(e) => {setQuantidadeEstoque(e.target.value)}} sx={{mb:2}}/>
                <Divider sx={{ mb:2}}/>
