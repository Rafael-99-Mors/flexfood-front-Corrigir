import { Button, Card, CardActions, CardContent, CardHeader, CardMedia, Container, Fab, Grid, Typography } from '@mui/material'
  ...
  return (
    <>
        <Fab onClick={enviarDados} sx={{
            ...
            variant='extended'
        >
            <Typography sx={{fontSize: 20, fontWeight:'bold', mr:2}}>R$ { valorTotal.toFixed(2) }</Typography>
            <LocalGroceryStore/>
        </Fab>
